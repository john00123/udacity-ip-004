...
# imported two functions,
# media with movie classes and fresh_tomatoes,
# with the script to generate html.
import media
import fresh_tomatoes

# To be PEP 8 compliant I have wrapped the
# values in parenthesis.
# In the url cases it was recommended not
# to break the url.
inception = media.Movie('Inception', ('''A thief, who steals corporate
 secrets through use of dream-sharing technology, is given
 the inverse task of planting an idea into the mind of a CEO.'''),  # noqa
...
bigHero6 = media.Movie('Big Hero 6', ('''The special bond that develops
 ...
 who team up with a group of friends to form a band of high-tech heroes.'''),  # noqa
...
theDarkKnight = media.Movie('The Dark Knight', ('''When the menace known as
 ...
 psychological and physical tests of his ability to fight injustice.'''),  # noqa
 'https://images-na.ssl-images-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_UX182_CR0,0,182,268_AL_.jpg',  # noqa
 'https://www.youtube.com/watch?v=kmJLuwP3MbY')

wallE = media.Movie('WALL E', ('''In the distant future, a small waste-collecting robot inadvertently embarks on a space journey that will ultimately decide the fate of mankind.'''),  # noqa
...
pansLabyrinth = media.Movie('''Pan's Labyrinth''', ('''In the falangist Spain
 ...
 into an eerie but captivating fantasy world.'''),  # noqa
 'https://images-na.ssl-images-amazon.com/images/M/MV5BMTU3ODg2NjQ5NF5BMl5BanBnXkFtZTcwMDEwODgzMQ@@._V1_UY268_CR0,0,182,268_AL_.jpg',  # noqa
